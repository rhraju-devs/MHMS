        ...
        <div class="row">
            ...
            <div class="col-12">
                <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{url('/forntend/images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg')}}"
                                class="img-fluid" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="{{url('/frontend/images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg')}}"
                                class="img-fluid" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="{{url('/frontend/images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg')}}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="heroText d-flex flex-column justify-content-center">
                    ...
                    <p class="mb-4">Medic Care is a Bootstrap 5 Template provided by TemplateMo website. Credits
                        go to FreePik and RawPixel for images used in this template.</p>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <p>You can feel free to use this CSS template for your medical profession or health care related
                    websites. You can <a rel="nofollow" href="http://paypal.me/templatemo" target="_blank">support us a
                        little</a> via PayPal if this template is good and useful
                    for your work.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-6 ps-0">
                <img src="{{url('/frontend/images/gallery/medium-shot-man-getting-vaccine.jpg')}}"
                    class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
            </div>

            <div class="col-lg-6 col-6 pe-0">
                <img src="{{url('/frontend/images/gallery/female-doctor-with-presenting-hand-gesture.jpg')}}"
                ...
                <div class="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
                    <div class="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                        ...
                        <p>If you need a working contact form that submits email to your inbox, please <a rel="nofollow"
                                href="https://templatemo.com/contact" target="_parent">visit our
            ...
            <div class="col-12">
                ...
                <div class="owl-carousel reviews-carousel">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{url('/frontend/images/reviews/beautiful-woman-face-portrait-brown-background.jpg')}}"
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{url('/frontend/images/reviews/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpg')}}"
                            class="img-fluid reviews-image" alt="">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{url('/frontend/images/reviews/portrait-british-woman.jpg')}}"
                            class="img-fluid reviews-image" alt="">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{url('/frontend/images/reviews/woman-wearing-mask-face-closeup-covid-19-green-background.jpg')}}"
                            class="img-fluid reviews-image" alt="">
